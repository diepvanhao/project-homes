...
<div style="margin: 50px 0px 0px 480px;background-color: #F1F5FE;width: 50%;height:55px; text-align: center;font-size: 1.8em;line-height: 55px;">ARP</div>
                        ...
                        <form action='user_login.php' method='POST' name='login'>
                            <table cellpadding='0' cellspacing='0' style='margin-left: 0px;' width="100%">
                                ...
                                <tr>
                                    ...
                                    <td class='form2'><input type='password' class='text' name='password' id='password' size='25' maxlength='50' style="height:26px; width: 172px;"> <div style="margin-top: 10px;"><a href='forgot.php'>Forgot password</a></div></td>
                                </tr>
