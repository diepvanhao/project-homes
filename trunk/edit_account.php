...
if (isset($_POST['submit'])) {
    ...
    if (empty($error)) {
        ...
        $result = $account->update($username, $password, $firstname, $lastname, $address, $email, $phone, $gender, $birthday, $photo, $position, $level, $target, $agent, $user_id);
        if ($result) {
