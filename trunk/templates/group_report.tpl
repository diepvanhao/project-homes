                    ...
                    <tr>
                        <td>
                            ...
                            <select id="agent_id" name="agent_id" style="height:26px; width: 251px;">
                                <option value=""></option>
                                {foreach from=$groups key=k item=agent}
                                <option value="{$agent.id}" {if isset($params.agent_id) && $params.agent_id eq $agent.id }selected="selected" {/if}>{$agent.group_name}</option>
                                {/foreach}
                            </select>
                        </td>
                    </tr>
