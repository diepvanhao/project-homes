...
<div style="background-color: #F1F5FE; width: 100%;height:55px; text-align: center;font-size: 1.8em;line-height: 55px; ">Group Registration</div>
{nocache}
    {if $error|@count gt 0}
    ...
    <form action="create_group.php" method="post">
        <table cellpadding='0' cellspacing='0' style='margin-left: 0px;' width="100%">
            ...
            <tr>
                <td class='form1'>Display <span class="required">*</span></td>
                <td class='form2'>
