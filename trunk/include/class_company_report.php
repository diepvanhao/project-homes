...
class CompanyReport {
     ...
     * @return array
     */
    public function getAgentInfo($agent_id = 0, $date = null, $fromdate = null) {
        ...
        //target 
        $select = "SELECT SUM(u.user_target) AS target FROM home_user AS u
            WHERE u.agent_id = {$agent_id} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        $return['target'] = (int) $row[0];
        ...
        $select = "SELECT SUM(d.contract_total) FROM home_order o
            ...
            INNER JOIN home_user u  ON u.id = o.user_id
        ...
        $select = "SELECT SUM(d.contract_total) FROM home_order o
            ...
            INNER JOIN home_contract_detail d  ON c.id = d.contract_id
            INNER JOIN home_user u  ON u.id = o.user_id
            WHERE u.agent_id = {$agent_id}  AND o.order_status = 1 AND DATE_FORMAT( FROM_UNIXTIME( o.order_day_create ) ,'%Y-%m')= '" . date("Y-m", strtotime(date('Y-m',$time). " -1 months")) . "'";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_contract_detail d ON c.id = d.contract_id
            INNER JOIN home_user u  ON u.id = o.user_id
            WHERE u.agent_id = {$agent_id} AND d.contract_application = 1 AND o.order_status = 1 AND {$today} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_contract_detail d ON c.id = d.contract_id
            INNER JOIN home_user u  ON u.id = o.user_id
            WHERE u.agent_id = {$agent_id} AND d.contract_application = 1 AND o.order_status = 1 AND {$month} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_user u  ON u.id = o.user_id
            WHERE u.agent_id = {$agent_id} AND o.order_status = 1 AND d.contract_cancel = 1 AND {$today} ";
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_contract_detail d  ON d.contract_id = c.id
            INNER JOIN home_user u  ON u.id = o.user_id
            WHERE u.agent_id = {$agent_id} AND o.order_status = 1 AND d.contract_cancel = 1 AND {$month} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_contract_detail d  ON d.contract_id = c.id
            INNER JOIN home_user u  ON u.id = o.user_id
            WHERE u.agent_id = {$agent_id} AND o.order_status = 1 AND d.contract_cancel = 0 AND  d.contract_signature_day IS NOT NULL AND  d.contract_signature_day <> '' AND {$today} ";
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_contract_detail d  ON d.contract_id = c.id
            INNER JOIN home_user u  ON u.id = o.user_id
            WHERE u.agent_id = {$agent_id} AND o.order_status = 1 AND d.contract_cancel = 0 AND  d.contract_signature_day IS NOT NULL AND  d.contract_signature_day <> '' AND {$month} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_contract_detail d  ON d.contract_id = c.id
            INNER JOIN home_user u  ON u.id = o.user_id
            WHERE u.agent_id = {$agent_id} AND o.order_status = 1 AND d.contract_ambition = 1 AND  d.contract_signature_day IS NOT NULL AND  d.contract_signature_day <> '' AND {$today} ";
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_contract_detail d  ON d.contract_id = c.id
            INNER JOIN home_user u  ON u.id = o.user_id
            WHERE u.agent_id = {$agent_id} AND o.order_status = 1 AND d.contract_ambition = 1 AND  d.contract_signature_day IS NOT NULL AND  d.contract_signature_day <> '' AND {$month} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
    ...
    public function getLastyearInfo($date = null, $fromdate = null) {
        global $database;
...
//        $year = "DATE_FORMAT( FROM_UNIXTIME( o.order_day_create ) ,'%Y')= '" . date('Y') . "'";
        ...
        $select = "SELECT SUM(log_shop_sign) AS todaymail_shop_sign, SUM(log_local_sign) AS todaymail_local_sign, SUM(log_introduction) AS todaymail_introduction, SUM(log_tel) AS todaymail_tel, 
            ...
            WHERE h.log_mail = 1 AND o.order_status = 1 AND  {$today}
            ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_assoc($result);
        $return = array_merge($return, $row);
        $select = "SELECT SUM(log_shop_sign) AS yearmail_shop_sign, SUM(log_local_sign) AS yearmail_local_sign, SUM(log_introduction) AS yearmail_introduction, SUM(log_tel) AS yearmail_tel, 
            ...
            INNER JOIN home_order o  ON o.id = h.order_id
            INNER JOIN home_user u  ON o.user_id = u.id
            WHERE h.log_mail = 1 AND o.order_status = 1 AND  {$year}
            ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_assoc($result);
        $return = array_merge($return, $row);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_contract_detail d ON c.id = d.contract_id
            WHERE d.contract_application = 1 AND h.log_mail = 1 AND o.order_status = 1 AND {$today} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_history_log h  ON o.id = h.order_id
            INNER JOIN home_contract_detail d ON c.id = d.contract_id
            WHERE d.contract_application = 1 AND h.log_mail = 1 AND o.order_status = 1 AND {$year} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_user u  ON o.user_id = u.id
            INNER JOIN home_history_log h  ON o.id = h.order_id
            WHERE h.log_mail = 1 AND o.order_status = 1 AND d.contract_cancel = 1 AND {$today} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_user u  ON o.user_id = u.id
            INNER JOIN home_history_log h  ON o.id = h.order_id
            WHERE h.log_mail = 1 AND o.order_status = 1 AND d.contract_cancel = 1 AND {$year} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_user u  ON o.user_id = u.id
            INNER JOIN home_history_log h  ON o.id = h.order_id
            WHERE h.log_mail = 1 AND o.order_status = 1 AND d.contract_cancel = 0 AND d.contract_signature_day IS NOT NULL AND  d.contract_signature_day <> '' AND {$today} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_user u  ON o.user_id = u.id
            INNER JOIN home_history_log h  ON o.id = h.order_id
            WHERE h.log_mail = 1 AND o.order_status = 1 AND d.contract_cancel = 0 AND d.contract_signature_day IS NOT NULL AND  d.contract_signature_day <> '' AND {$year} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT SUM(log_shop_sign) AS todayphone_shop_sign, SUM(log_local_sign) AS todayphone_local_sign, SUM(log_introduction) AS todayphone_introduction, SUM(log_tel) AS todayphone_tel, 
            ...
            INNER JOIN home_order o  ON o.id = h.order_id
            INNER JOIN home_user u  ON o.user_id = u.id
            WHERE h.log_tel = 1 AND o.order_status = 1 AND  {$today}
            ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_assoc($result);
        $return = array_merge($return, $row);
        $select = "SELECT SUM(log_shop_sign) AS yearphone_shop_sign, SUM(log_local_sign) AS yearphone_local_sign, SUM(log_introduction) AS yearphone_introduction, SUM(log_tel) AS yearphone_tel, 
            ...
            INNER JOIN home_order o  ON o.id = h.order_id
            INNER JOIN home_user u  ON o.user_id = u.id
            WHERE h.log_tel = 1 AND o.order_status = 1 AND  {$year}
            ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_assoc($result);
        $return = array_merge($return, $row);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_history_log h  ON o.id = h.order_id
            INNER JOIN home_contract_detail d ON c.id = d.contract_id
            WHERE d.contract_application = 1 AND h.log_tel = 1 AND o.order_status = 1 AND {$today} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_history_log h  ON o.id = h.order_id
            INNER JOIN home_contract_detail d ON c.id = d.contract_id
            WHERE d.contract_application = 1 AND h.log_tel = 1 AND o.order_status = 1 AND {$year} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_user u  ON o.user_id = u.id
            INNER JOIN home_history_log h  ON o.id = h.order_id
            WHERE h.log_tel = 1 AND o.order_status = 1 AND d.contract_cancel = 1 AND {$today} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_user u  ON o.user_id = u.id
            INNER JOIN home_history_log h  ON o.id = h.order_id
            WHERE h.log_tel = 1 AND o.order_status = 1 AND d.contract_cancel = 1 AND {$year} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_user u  ON o.user_id = u.id
            INNER JOIN home_history_log h  ON o.id = h.order_id
            WHERE h.log_tel = 1 AND o.order_status = 1 AND d.contract_cancel = 0 AND  d.contract_signature_day IS NOT NULL AND d.contract_signature_day <> '' AND {$today} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_user u  ON o.user_id = u.id
            INNER JOIN home_history_log h  ON o.id = h.order_id
            WHERE h.log_tel = 1 AND o.order_status = 1 AND d.contract_cancel = 0 AND  d.contract_signature_day IS NOT NULL AND  d.contract_signature_day <> '' AND {$year} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT SUM(log_shop_sign) AS todaydiscount_shop_sign, SUM(log_local_sign) AS todaydiscount_local_sign, SUM(log_introduction) AS todaydiscount_introduction, SUM(log_tel) AS todaydiscount_tel, 
            ...
            WHERE d.room_discount > 0 AND o.order_status = 1 AND  {$today}
            ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_assoc($result);
        $return = array_merge($return, $row);
        ...
        $select = "SELECT SUM(log_shop_sign) AS yeardiscount_shop_sign, SUM(log_local_sign) AS yeardiscount_local_sign, SUM(log_introduction) AS yeardiscount_introduction, SUM(log_tel) AS yeardiscount_tel, 
            ...
            INNER JOIN home_room r  ON r.id = o.room_id AND r.house_id = o.house_id
            INNER JOIN home_room_detail d  ON d.id = r.room_detail_id
            WHERE d.room_discount > 0 AND o.order_status = 1 AND  {$year}
            ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_assoc($result);
        $return = array_merge($return, $row);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_room_detail d  ON d.id = r.room_detail_id
            INNER JOIN home_contract_detail d ON c.id = d.contract_id
            WHERE d.contract_application = 1 AND d.room_discount > 0 AND o.order_status = 1 AND {$today} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_room_detail d  ON d.id = r.room_detail_id
            INNER JOIN home_contract_detail d ON c.id = d.contract_id
            WHERE d.contract_application = 1 AND d.room_discount > 0 AND o.order_status = 1 AND {$year} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_room r  ON r.id = o.room_id AND r.house_id = o.house_id
            INNER JOIN home_room_detail d  ON d.id = r.room_detail_id
            WHERE d.room_discount > 0 AND o.order_status = 1 AND d.contract_cancel = 1 AND {$today} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_room r  ON r.id = o.room_id AND r.house_id = o.house_id
            INNER JOIN home_room_detail d  ON d.id = r.room_detail_id
            WHERE d.room_discount > 0 AND o.order_status = 1 AND d.contract_cancel = 1 AND {$year} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_room r  ON r.id = o.room_id AND r.house_id = o.house_id
            INNER JOIN home_room_detail d  ON d.id = r.room_detail_id
            WHERE d.room_discount > 0   AND o.order_status = 1 AND d.contract_cancel = 0 AND  d.contract_signature_day IS NOT NULL AND  d.contract_signature_day <> '' AND {$today} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            WHERE hh.house_discount > 0  AND o.order_status = 1 AND d.contract_cancel = 0 AND  d.contract_signature_day IS NOT NULL AND  d.contract_signature_day <> '' AND {$year} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT SUM(log_shop_sign) AS todaylocalsign_shop_sign, SUM(log_local_sign) AS todaylocalsign_local_sign, SUM(log_introduction) AS todaylocalsign_introduction, SUM(log_tel) AS todaylocalsign_tel, 
            ...
            INNER JOIN home_order o  ON o.id = h.order_id
            INNER JOIN home_user u  ON o.user_id = u.id
            WHERE h.log_local_sign = 1 AND o.order_status = 1 AND  {$today}
            ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_assoc($result);
        $return = array_merge($return, $row);
        ...
        $select = "SELECT SUM(log_shop_sign) AS yearlocalsign_shop_sign, SUM(log_local_sign) AS yearlocalsign_local_sign, SUM(log_introduction) AS yearlocalsign_introduction, SUM(log_tel) AS yearlocalsign_tel, 
            ...
            INNER JOIN home_order o  ON o.id = h.order_id
            INNER JOIN home_user u  ON o.user_id = u.id
            WHERE h.log_local_sign = 1 AND o.order_status = 1 AND  {$year}
            ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_assoc($result);
        $return = array_merge($return, $row);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_history_log h  ON o.id = h.order_id
            INNER JOIN home_contract_detail d ON c.id = d.contract_id
            WHERE d.contract_application = 1 AND h.log_local_sign = 1 AND o.order_status = 1 AND {$today} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_history_log h  ON o.id = h.order_id
            INNER JOIN home_contract_detail d ON c.id = d.contract_id
            WHERE d.contract_application = 1 AND h.log_local_sign = 1 AND o.order_status = 1 AND {$year} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_user u  ON o.user_id = u.id
            INNER JOIN home_history_log h  ON o.id = h.order_id
            WHERE h.log_local_sign = 1 AND o.order_status = 1 AND d.contract_cancel = 1 AND {$today} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_user u  ON o.user_id = u.id
            INNER JOIN home_history_log h  ON o.id = h.order_id
            WHERE h.log_local_sign = 1 AND o.order_status = 1 AND d.contract_cancel = 1 AND {$year} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_user u  ON o.user_id = u.id
            INNER JOIN home_history_log h  ON o.id = h.order_id
            WHERE h.log_local_sign = 1 AND o.order_status = 1 AND d.contract_cancel = 0 AND  d.contract_signature_day IS NOT NULL AND  d.contract_signature_day <> '' AND {$today} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_user u  ON o.user_id = u.id
            INNER JOIN home_history_log h  ON o.id = h.order_id
            WHERE h.log_local_sign = 1 AND o.order_status = 1 AND d.contract_cancel = 0 AND  d.contract_signature_day IS NOT NULL AND  d.contract_signature_day <> '' AND {$year} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT SUM(log_shop_sign) AS todayintroduction_shop_sign, SUM(log_local_sign) AS todayintroduction_local_sign, SUM(log_introduction) AS todayintroduction_introduction, SUM(log_tel) AS todayintroduction_tel, 
            ...
            INNER JOIN home_order o  ON o.id = h.order_id
            INNER JOIN home_user u  ON o.user_id = u.id
            WHERE h.log_introduction = 1 AND o.order_status = 1 AND  {$today}
            ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_assoc($result);
        $return = array_merge($return, $row);
        ...
        $select = "SELECT SUM(log_shop_sign) AS yearintroduction_shop_sign, SUM(log_local_sign) AS yearintroduction_local_sign, SUM(log_introduction) AS yearintroduction_introduction, SUM(log_tel) AS yearintroduction_tel, 
            ...
            INNER JOIN home_order o  ON o.id = h.order_id
            INNER JOIN home_user u  ON o.user_id = u.id
            WHERE h.log_introduction = 1 AND o.order_status = 1 AND  {$year}
            ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_assoc($result);
        $return = array_merge($return, $row);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_history_log h  ON o.id = h.order_id
            INNER JOIN home_contract_detail d ON c.id = d.contract_id
            WHERE d.contract_application = 1 AND h.log_introduction = 1 AND o.order_status = 1 AND {$today} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_history_log h  ON o.id = h.order_id
            INNER JOIN home_contract_detail d ON c.id = d.contract_id
            WHERE d.contract_application = 1 AND h.log_introduction = 1 AND o.order_status = 1 AND {$year} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_user u  ON o.user_id = u.id
            INNER JOIN home_history_log h  ON o.id = h.order_id
            WHERE h.log_introduction = 1 AND o.order_status = 1 AND d.contract_cancel = 1 AND {$today} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_user u  ON o.user_id = u.id
            INNER JOIN home_history_log h  ON o.id = h.order_id
            WHERE h.log_introduction = 1 AND o.order_status = 1 AND d.contract_cancel = 1 AND {$year} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_user u  ON o.user_id = u.id
            INNER JOIN home_history_log h  ON o.id = h.order_id
            WHERE h.log_introduction = 1 AND o.order_status = 1 AND d.contract_cancel = 0 AND  d.contract_signature_day IS NOT NULL AND  d.contract_signature_day <> '' AND {$today} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_user u  ON o.user_id = u.id
            INNER JOIN home_history_log h  ON o.id = h.order_id
            WHERE h.log_introduction = 1 AND o.order_status = 1 AND d.contract_cancel = 0 AND  d.contract_signature_day IS NOT NULL AND  d.contract_signature_day <> '' AND {$year} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT SUM(log_shop_sign) AS todayshopsign_shop_sign, SUM(log_local_sign) AS todayshopsign_local_sign, SUM(log_introduction) AS todayshopsign_introduction, SUM(log_tel) AS todayshopsign_tel, 
            ...
            INNER JOIN home_order o  ON o.id = h.order_id
            INNER JOIN home_user u  ON o.user_id = u.id
            WHERE h.log_shop_sign = 1 AND o.order_status = 1 AND  {$today}
            ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_assoc($result);
        $return = array_merge($return, $row);
        ...
        $select = "SELECT SUM(log_shop_sign) AS yearshopsign_shop_sign, SUM(log_local_sign) AS yearshopsign_local_sign, SUM(log_introduction) AS yearshopsign_introduction, SUM(log_tel) AS yearshopsign_tel, 
            ...
            INNER JOIN home_order o  ON o.id = h.order_id
            INNER JOIN home_user u  ON o.user_id = u.id
            WHERE h.log_shop_sign = 1 AND o.order_status = 1 AND  {$year}
            ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_assoc($result);
        $return = array_merge($return, $row);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_history_log h  ON o.id = h.order_id
            INNER JOIN home_contract_detail d ON c.id = d.contract_id
            WHERE d.contract_application = 1 AND h.log_shop_sign = 1 AND o.order_status = 1 AND {$today} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_history_log h  ON o.id = h.order_id
            INNER JOIN home_contract_detail d ON c.id = d.contract_id
            WHERE d.contract_application = 1 AND h.log_shop_sign = 1 AND o.order_status = 1 AND {$year} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_user u  ON o.user_id = u.id
            INNER JOIN home_history_log h  ON o.id = h.order_id
            WHERE h.log_shop_sign = 1 AND o.order_status = 1 AND d.contract_cancel = 1 AND {$today} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_user u  ON o.user_id = u.id
            INNER JOIN home_history_log h  ON o.id = h.order_id
            WHERE h.log_shop_sign = 1 AND o.order_status = 1 AND d.contract_cancel = 1 AND {$year} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_user u  ON o.user_id = u.id
            INNER JOIN home_history_log h  ON o.id = h.order_id
            WHERE h.log_shop_sign = 1 AND o.order_status = 1 AND d.contract_cancel = 0 AND  d.contract_signature_day IS NOT NULL AND  d.contract_signature_day <> '' AND {$today} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_user u  ON o.user_id = u.id
            INNER JOIN home_history_log h  ON o.id = h.order_id
            WHERE h.log_shop_sign = 1 AND o.order_status = 1 AND d.contract_cancel = 0 AND  d.contract_signature_day IS NOT NULL  AND  d.contract_signature_day <> '' AND {$year} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT SUM(log_shop_sign) AS todayflyer_shop_sign, SUM(log_local_sign) AS todayflyer_local_sign, SUM(log_introduction) AS todayflyer_introduction, SUM(log_tel) AS todayflyer_tel, 
            ...
            INNER JOIN home_order o  ON o.id = h.order_id
            INNER JOIN home_user u  ON o.user_id = u.id
            WHERE h.log_flyer = 1 AND o.order_status = 1 AND  {$today}
            ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_assoc($result);
        $return = array_merge($return, $row);
        ...
        $select = "SELECT SUM(log_shop_sign) AS yearflyer_shop_sign, SUM(log_local_sign) AS yearflyer_local_sign, SUM(log_introduction) AS yearflyer_introduction, SUM(log_tel) AS yearflyer_tel, 
            ...
            INNER JOIN home_order o  ON o.id = h.order_id
            INNER JOIN home_user u  ON o.user_id = u.id
            WHERE h.log_flyer = 1 AND o.order_status = 1 AND  {$year}
            ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_assoc($result);
        $return = array_merge($return, $row);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_history_log h  ON o.id = h.order_id
            INNER JOIN home_contract_detail d ON c.id = d.contract_id
            WHERE d.contract_application = 1 AND h.log_flyer = 1 AND o.order_status = 1 AND {$today} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_history_log h  ON o.id = h.order_id
            INNER JOIN home_contract_detail d ON c.id = d.contract_id
            WHERE d.contract_application = 1 AND h.log_flyer = 1 AND o.order_status = 1 AND {$year} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_user u  ON o.user_id = u.id
            INNER JOIN home_history_log h  ON o.id = h.order_id
            WHERE h.log_flyer = 1 AND o.order_status = 1 AND d.contract_cancel = 1 AND {$today} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_user u  ON o.user_id = u.id
            INNER JOIN home_history_log h  ON o.id = h.order_id
            WHERE h.log_flyer = 1 AND o.order_status = 1 AND d.contract_cancel = 1 AND {$year} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_user u  ON o.user_id = u.id
            INNER JOIN home_history_log h  ON o.id = h.order_id
            WHERE h.log_flyer = 1 AND o.order_status = 1 AND d.contract_cancel = 0 AND  d.contract_signature_day IS NOT NULL AND  d.contract_signature_day <> '' AND {$today} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_user u  ON o.user_id = u.id
            INNER JOIN home_history_log h  ON o.id = h.order_id
            WHERE h.log_flyer = 1 AND o.order_status = 1 AND d.contract_cancel = 0 AND  d.contract_signature_day IS NOT NULL AND  d.contract_signature_day <> '' AND {$year} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT SUM(log_shop_sign) AS todayline_shop_sign, SUM(log_local_sign) AS todayline_local_sign, SUM(log_introduction) AS todayline_introduction, SUM(log_tel) AS todayline_tel, 
            ...
            INNER JOIN home_order o  ON o.id = h.order_id
            INNER JOIN home_user u  ON o.user_id = u.id
            WHERE h.log_line = 1 AND o.order_status = 1 AND  {$today}
            ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_assoc($result);
        $return = array_merge($return, $row);
        ...
        $select = "SELECT SUM(log_shop_sign) AS yearline_shop_sign, SUM(log_local_sign) AS yearline_local_sign, SUM(log_introduction) AS yearline_introduction, SUM(log_tel) AS yearline_tel, 
            ...
            INNER JOIN home_order o  ON o.id = h.order_id
            INNER JOIN home_user u  ON o.user_id = u.id
            WHERE h.log_line = 1 AND o.order_status = 1 AND  {$year}
            ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_assoc($result);
        $return = array_merge($return, $row);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_history_log h  ON o.id = h.order_id
            INNER JOIN home_contract_detail d ON c.id = d.contract_id
            WHERE d.contract_application = 1 AND h.log_line = 1 AND o.order_status = 1 AND {$today} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_history_log h  ON o.id = h.order_id
            INNER JOIN home_contract_detail d ON c.id = d.contract_id
            WHERE d.contract_application = 1 AND h.log_line = 1 AND o.order_status = 1 AND {$year} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_user u  ON o.user_id = u.id
            INNER JOIN home_history_log h  ON o.id = h.order_id
            WHERE h.log_line = 1 AND o.order_status = 1 AND d.contract_cancel = 1 AND {$today} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_user u  ON o.user_id = u.id
            INNER JOIN home_history_log h  ON o.id = h.order_id
            WHERE h.log_line = 1 AND o.order_status = 1 AND d.contract_cancel = 1 AND {$year} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_user u  ON o.user_id = u.id
            INNER JOIN home_history_log h  ON o.id = h.order_id
            WHERE h.log_line = 1 AND o.order_status = 1 AND d.contract_cancel = 0 AND  d.contract_signature_day IS NOT NULL AND  d.contract_signature_day <> '' AND {$today} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
        ...
        $select = "SELECT COUNT(*) FROM home_order o
            ...
            INNER JOIN home_user u  ON o.user_id = u.id
            INNER JOIN home_history_log h  ON o.id = h.order_id
            WHERE h.log_line = 1 AND o.order_status = 1 AND d.contract_cancel = 0 AND  d.contract_signature_day IS NOT NULL AND  d.contract_signature_day <> '' AND  {$year} ";
        $result = $database->database_query($select);
        $row = $database->database_fetch_array($result);
