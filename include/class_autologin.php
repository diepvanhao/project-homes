...
class Autologin {
    ...
    /*    $this->brokers = array(
            ...
            array('name' => "TFD", 'action' => "https://tfd.es-b2b.com/?wicket:interface=:0:signInPanel:signInForm::IFormSubmitListener", 'username' => "19764RC", 'password' => "QU3F792MGQ", 'idlogname' => "username", 'passlogname' => "password"),
